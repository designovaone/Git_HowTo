...
4. to let local git repo know a remote repo  
   **$git remote add origin** [**https://github.com/designovaone/Git\_HowTo.git**](https://github.com/designovaone/Git_HowTo.git)
...
DS\_files are setting files shown
...
### to git by add and commit **D.** Templates from githut on github/gitingore [https://github.com/github/gitignore](https://github.com/github/gitignore) and search for type, e.g. node a. copy and add into .gitignore
...
Copy a repo, collab have full permission, write access  
the read-only as contributors can merge back with **pull** request  
person who has write access or owner, can review and pull changes back in
